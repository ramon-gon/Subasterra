...
++++
include::styles_guide/color_palette.html[]
++++

La idea es fer un disseny minimalista amb fons **blanc** i la tipografia de color **negre**. La idea es fer ús del **gris** per donar volum a la  pàgina web i algunes decoracions amb un color **crema**. Per resaltar elements de la web farem ús del **daurat** i quan volguem fer una crida a la acció utilitzarem el color **vermell**.

=== Tipografia

++++
include::styles_guide/logo.html[]
++++
[source, css]
----
{
...
++++
include::styles_guide/general.html[]
++++
[source, css]
----
{
...
++++
include::styles_guide/categories.html[]
++++
[source, css]
----
{
...
++++
include::styles_guide/titles.html[]
++++
[source, css]
----
{
...
++++
include::styles_guide/subtitles.html[]
++++
...
++++
include::styles_guide/buttons_prototype_1.html[]
++++
...
++++
include::styles_guide/links_prototype_1.html[]
++++

=== Elements de formulari:
++++
include::styles_guide/form_prototype_1.html[]
++++
...
https://drive.google.com/file/d/1Y18KrAgeyOQ7Dl8aT-LCpGar8g0uD_9X/view?usp=sharing[Diagrama Entitat Relació]
